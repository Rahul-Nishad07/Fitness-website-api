...
{
    public class delete_subscribers
    {
        dbServices ds = new dbServices();
        public async Task<responseData> Delete_subscribers(requestData rData)
        {
            ...
            {
                // Your update query
                var query = @"DELETE FROM pc_student.subscribe WHERE id = @id";
