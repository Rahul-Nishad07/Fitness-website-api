...
{
    public class delete_informations
    {
        dbServices ds = new dbServices();
        public async Task<responseData> Delete_informations(requestData rData)
        {
            ...
            {
                // Your update query
                var query = @"DELETE FROM pc_student.Packageplan WHERE id = @id";
