...
{
    public class getallSubsciber
    {
        dbServices ds = new dbServices();

        public async Task<responseData> GetallSubsciber(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from pc_student.subscribe";
                ...
                resData.rData["rMessage"] = allclass;
                    ...
                    resData.rData["rMessage"]="No Subscibers";
                }    
