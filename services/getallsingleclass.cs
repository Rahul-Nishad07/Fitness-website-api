...
{
    public class getallsingleclass
    {
        dbServices ds = new dbServices();

        public async Task<responseData> Getallsingleclass(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from pc_student.Singleclass";
                ...
                resData.rData["rMessage"] = allclass;
                    ...
                    resData.rData["rMessage"]="Not any classes";
                }    
