...
namespace COMMON_PROJECT_STRUCTURE_API.services
{
    public class getAllInformation
    {
        ...
        public async Task<responseData> GetAllInformation(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from pc_student.information";
                ...
                resData.rData["rMessage"] = allclass;
                    ...
                    resData.rData["rMessage"]="No Information";
                }    
