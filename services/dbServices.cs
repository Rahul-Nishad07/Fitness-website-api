...
//Update query start
    ...
    // Delete Query
     ...
     public int ExecuteDeleteSQL(string sql, MySqlParameter[] parameters)
    {
        MySqlTransaction transaction = null;
        int rowsAffected = 0;
...
{
    // This is a mock method. Replace with your actual authentication logic.
    public async Task<string> Authenticate(string username, string password)
    {
        // Replace with your actual user authentication logic, e.g., checking a database
        if (username == "admin" && password == "password")
        {
            // Generate and return a JWT token (this is a mock token for demonstration)
