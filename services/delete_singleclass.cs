...
{
    public class delete_singleclass
    {
        dbServices ds = new dbServices();
        public async Task<responseData> Delete_singleclass(requestData rData)
        {
            ...
            {
                // Your update query
                var query = @"DELETE FROM pc_student.Singleclass WHERE id = @id";
